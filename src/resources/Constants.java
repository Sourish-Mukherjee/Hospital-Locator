...
public interface Constants {
    ...
    final static String read = "<html> <b> 1.</b> Click on empty space to create new node\n" 
            + "<html> <b> 2.</b> Drag from node to node to create an edge\n"
            + "<html> <b> 3. </b>Click on edges to set the weight\n"
            ...
            + "<html><li>Shitft + Middle Mouse\t : <u>Mark Red Zones</html>";
